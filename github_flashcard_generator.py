...
def main():
    ...
    if len(sys.argv) < 2:
        print("Usage: python github_flashcard_generator.py <pdf_file> [--max-chunks N] [--cards-per-chunk N] [--model MODEL_ID]")
        sys.exit(1)
    ...
    print(f"Generating flashcards using model: {model_id}")
